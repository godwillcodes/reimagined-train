...
<style>
.symp-atmo { position:absolute; inset:0; pointer-events:none; }
.symp-atmo--hero {
  background:
    radial-gradient(ellipse 72% 48% at 50% -12%, rgba(152,196,65,.16) 0%, transparent 58%),
    radial-gradient(ellipse 54% 42% at 88% 52%,  rgba(0,97,85,.22)   0%, transparent 60%),
    radial-gradient(ellipse 80% 44% at 50% 110%, rgba(0,97,85,.26)   0%, transparent 60%);
}
.symp-atmo--section {
  background:
    radial-gradient(ellipse 60% 44% at 50% -6%,  rgba(152,196,65,.09) 0%, transparent 62%),
    radial-gradient(ellipse 80% 40% at 50% 110%, rgba(0,97,85,.16)    0%, transparent 58%);
}
.symp-atmo--alt {
  background:
    radial-gradient(ellipse 58% 48% at 16% 30%,  rgba(152,196,65,.09) 0%, transparent 58%),
    radial-gradient(ellipse 64% 52% at 86% 86%,  rgba(0,97,85,.20)    0%, transparent 60%);
}
</style>
...
<section class="shadow-sm bg-[#1F3131]" aria-labelledby="symposium-hero-heading">
    <div class="relative py-16 lg:py-20 bg-cover bg-no-repeat bg-right-bottom overflow-hidden"
        style="background-image: url('<?php echo esc_url(get_template_directory_uri() . '/assets/icons/single-industries.svg'); ?>');">

        <!-- Atmosphere overlay -->
        <div class="symp-atmo symp-atmo--hero" aria-hidden="true"></div>
        ...
        <div class="relative z-10">
            <div class="max-w-7xl mx-auto px-6 lg:px-0">
                ...
                <div class="inline-flex items-stretch overflow-hidden border border-[#98C441]/20 mb-5"
                    role="doc-subtitle">
                ...
                <!-- Heading -->
                <?php if ($event_title): ?>
                <h1 id="symposium-hero-heading" class="text-[clamp(2.5rem,5.5vw,4.5rem)] font-extrabold leading-[1.05] tracking-[-0.042em] text-[#F2EFE9] max-w-5xl mb-6">
                ...
                <div class="max-w-3xl lg:max-w-5xl mb-10">
                    <div class="prose prose-invert max-w-none text-base md:text-lg text-[#F2EFE9]/75 leading-relaxed prose-p:my-3 prose-headings:text-[#F2EFE9] prose-a:text-[#98C441] prose-a:underline hover:prose-a:no-underline">
                ...
                ?>
                <div class="bg-white/[.07] backdrop-blur-md border border-white/[.12] rounded-2xl p-3 lg:p-5 mb-10 max-w-5xl">
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-4">

                        <!-- Date -->
                        <?php if ($event_date_day || $event_date): ?>
                        <div class="flex items-start gap-4">
                            <div class="w-12 h-12 rounded-xl bg-[#98C441]/18 ring-1 ring-inset ring-[#98C441]/30 flex items-center justify-center flex-shrink-0">
                            ...
                            <div>
                                ...
                                <p class="text-[#F2EFE9] font-semibold"><?php echo esc_html($event_date_day); ?></p>
                                <?php endif; ?>
                                <?php if ($event_date): ?>
                                <p class="text-[#F2EFE9]/75"><?php echo esc_html($event_date); ?></p>
                                <?php endif; ?>
                            </div>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <?php if ($event_time): ?>
                                <p class="text-[#F2EFE9] font-semibold"><?php echo esc_html($event_time); ?></p>
                                <?php endif; ?>
                                <?php if ($event_timezone): ?>
                                <p class="<?php echo ! $event_time ? 'text-[#F2EFE9] font-semibold' : 'text-[#F2EFE9]/75'; ?>"><?php echo esc_html($event_timezone); ?></p>
                                <?php endif; ?>
                            </div>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-[#F2EFE9] font-semibold"><?php echo esc_html($event_location_name); ?></p>
                                <?php endif; ?>
                                <?php if ($event_location_city): ?>
                                <p class="text-[#F2EFE9]/75"><?php echo esc_html($event_location_city); ?></p>
                                <?php endif; ?>
                            </div>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-[#F2EFE9] font-semibold"><?php echo esc_html($event_refreshments_title); ?></p>
                                <?php endif; ?>
                                <?php if ($event_refreshments_description): ?>
                                <p class="text-[#F2EFE9]/75"><?php echo esc_html($event_refreshments_description); ?></p>
                                <?php endif; ?>
                            </div>
                        </div>
                        <?php endif; ?>
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    ...
                    <a href="<?php echo esc_url($cta_button_url ?: '#register'); ?>"
                        class="inline-flex items-center justify-center gap-2 rounded-[8px] bg-[#98C441] px-[22px] py-[13px] text-base font-bold text-[#080F0F] transition
                          ...
                          focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#98C441] focus-visible:ring-offset-2 focus-visible:ring-offset-[#1F3131]">
                    ...
                    <?php endif; ?>
                    <?php if ($cta_subtext): ?>
                    <span class="inline-flex items-center gap-2 text-[#F2EFE9]/60 text-sm px-4 py-4">
...
<?php if ( is_page(1715) ) : ?>
    ...
    <aside class="mt-10 max-w-2xl border border-white/[0.14] bg-[linear-gradient(120deg,rgba(255,255,255,0.08),rgba(255,255,255,0.03))] px-5 py-2 shadow-[0_20px_50px_-12px_rgba(15,23,42,0.35)] backdrop-blur-[2px] md:px-7 md:py-4"
        aria-label="<?php echo esc_attr__( 'Event sponsors', 'piedmontglobal' ); ?>">
...
<?php endif; ?>
        ...
        <!-- Bottom seam fade -->
        <div class="pointer-events-none absolute bottom-0 left-0 right-0 h-24" aria-hidden="true"
             style="background: linear-gradient(to bottom, transparent, #080F0F);"></div>
    </div>
</section>
...
?>
<section class="relative py-20 bg-[#080F0F] overflow-hidden">
    <div class="symp-atmo symp-atmo--section" aria-hidden="true"></div>
    <div class="relative z-10 max-w-7xl mx-auto px-6 lg:px-0">
        ...
        <div class="max-w-3xl mb-10 md:mb-16">
            ...
            <h2 id="<?php echo esc_attr($agenda_heading_id); ?>"
                class="text-[clamp(2rem,4vw,3.4rem)] font-extrabold leading-[1.08] tracking-[-0.042em] text-[#F2EFE9] mb-4">
        ...
        <div class="symposium-agenda-wrap overflow-x-auto max-md:overflow-x-visible rounded-xl border border-white/[.08] overflow-hidden"
            style="background: linear-gradient(180deg, rgba(255,255,255,.045), rgba(255,255,255,.018)), radial-gradient(circle at 50% 0%, rgba(152,196,65,.10), transparent 58%); box-shadow: 0 28px 90px rgba(0,0,0,.34), inset 0 1px 0 rgba(255,255,255,.055);"
            role="region"
            <?php
            ...
            <table class="symposium-agenda-table w-full min-w-0 table-fixed border-collapse text-left">
                ...
                <thead>
                    <tr class="border-b border-white/[.07] bg-white/[.04]">
                        <th scope="col"
                            class="w-[30%] max-w-[11rem] py-4 pl-6 pr-4 align-bottom text-[10px] font-semibold uppercase tracking-[.11em] text-[#F2EFE9]/50">
                            <?php esc_html_e('Time', 'piedmontglobal'); ?>
                        </th>
                        <th scope="col"
                            class="py-4 pl-4 pr-6 align-bottom text-[10px] font-semibold uppercase tracking-[.11em] text-[#F2EFE9]/50">
                ...
                <tbody>
                    <?php foreach ($agenda_sessions as $session) :
                        ...
                        ?>
                    <tr class="border-b border-white/[.07] transition-colors last:border-b-0 hover:bg-[#98C441]/[.055]">
                        <td class="align-top border-r border-white/[.07] py-5 pl-6 pr-4">
                            <?php if ($session_time) : ?>
                            <span class="block text-xs font-semibold uppercase tracking-[.12em] text-[#F2EFE9] tabular-nums">
                                <?php echo esc_html($session_time); ?>
                            </span>
                            <?php else : ?>
                            <span class="text-[#F2EFE9]/35">&mdash;</span>
                            <?php endif; ?>
                        </td>
                        <td class="align-top break-words py-5 pl-4 pr-6">
                            <?php if ($session_title) : ?>
                            <h3 class="text-xl font-bold leading-snug text-[#F2EFE9]">
                                <?php echo esc_html($session_title); ?>
                            </h3>
                            <?php endif; ?>
                            <?php if ($session_description) : ?>
                            <div class="<?php echo $session_title ? 'mt-2' : 'mt-0'; ?> text-sm prose prose-invert leading-relaxed text-[#F2EFE9]/55 md:text-base">
...
?>
<section class="relative py-24 md:py-32 overflow-hidden bg-[#0A1414]">
    <div class="symp-atmo symp-atmo--alt" aria-hidden="true"></div>

    <div class="relative max-w-7xl mx-auto px-6 lg:px-0">
        <!-- Section Header + carousel controls -->
        <div class="flex flex-col gap-8 md:flex-row md:items-end md:justify-between mb-10 md:mb-14">
            <div class="max-w-2xl">
                <div class="inline-flex items-stretch overflow-hidden border border-[#98C441]/20 mb-5"
                    role="doc-subtitle">
                    <div class="w-[2.5px] self-stretch bg-[#98C441]/55 flex-shrink-0"></div>
                ...
                <h2 class="text-[clamp(2rem,4vw,3.4rem)] font-extrabold leading-[1.08] tracking-[-0.042em] text-[#F2EFE9]">Featured Speakers</h2>
            </div>
            <div class="flex shrink-0 items-center gap-3">
                <button type="button" id="symposium-speakers-prev" aria-label="<?php echo esc_attr__('Previous speakers', 'piedmontglobal'); ?>"
                    class="p-2 bg-white/[.07] border border-white/[.10] rounded text-[#F2EFE9]/60 hover:bg-[#98C441] hover:text-[#080F0F] hover:border-[#98C441] transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[#98C441] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0A1414]">
        ...
        <div class="relative">
            ...
            <div class="group relative flex h-full min-h-0 flex-col overflow-hidden rounded-2xl border border-[rgba(242,239,233,.08)] transition-all duration-300 ease-out hover:-translate-y-1 focus-within:-translate-y-1"
                 style="background: linear-gradient(180deg,rgba(255,255,255,.045),rgba(255,255,255,.018)); box-shadow: 0 24px 70px rgba(0,0,0,.38);">

                <!-- Primary action: open bio modal -->
                <button
                    type="button"
                    onclick="openSpeakerModal(<?php echo (int) $index; ?>)"
                    class="absolute inset-0 z-10 cursor-pointer rounded-2xl bg-transparent text-left outline-none focus:outline-none focus-visible:ring-2 focus-visible:ring-[#98C441] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0A1414]"
                    aria-label="<?php
                ...
                <!-- Photo -->
                <div class="relative aspect-[4/5] w-full flex-shrink-0 overflow-hidden bg-[#0C1C1C]">
                    <?php if ($speaker_image): ?>
                        ...
                        >
                    <?php else: ?>
                        <div class="w-full h-full bg-[#1F3131]/30 flex items-center justify-center">
                            <span class="text-5xl font-bold text-[#F2EFE9]/20" aria-hidden="true">
                                <?php
                    ...
                    <div class="pointer-events-none absolute inset-0 bg-gradient-to-t from-[#080F0F]/92 via-[#0A1414]/35 to-transparent opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity duration-300" aria-hidden="true"></div>
                ...
                <!-- Info -->
                <div class="relative flex flex-1 flex-col border-t border-white/[.07] p-5 md:p-6 bg-transparent">
                    ...
                    <div class="flex items-start justify-between gap-4">
                        <div class="min-w-0 flex-1">
                            <?php if ($speaker_name): ?>
                                <h3 class="text-lg font-semibold tracking-tight text-[#F2EFE9] md:text-xl mb-1 transition-colors duration-200">
                                    <?php echo esc_html($speaker_name); ?>
                                </h3>
                            <?php endif; ?>
                            <?php if ($speaker_title): ?>
                                <p class="text-sm font-medium leading-snug text-[#F2EFE9]/50 line-clamp-2">
                        ...
                        <div class="flex items-center gap-2">
                            <?php if (!empty($speaker_linkedin)) : ?>
                                <a
                                    ...
                                    class="relative z-20 inline-flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-lg border border-white/[.10] bg-white/[.06] text-[#F2EFE9]/50 transition-colors duration-200 hover:border-[#0a66c2]/40 hover:bg-[#0a66c2] hover:text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-[#0a66c2] focus-visible:ring-offset-2"
                                    aria-label="<?php
                            ...
                            <?php endif; ?>
                            <div class="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-lg border border-white/[.10] bg-white/[.04] text-[#F2EFE9]/40 transition-all duration-300 group-hover:border-[#98C441]/35 group-hover:bg-[#98C441]/10 group-hover:text-[#F2EFE9] group-focus-within:border-[#98C441]/35 group-focus-within:bg-[#98C441]/10 group-focus-within:text-[#F2EFE9]" aria-hidden="true">
...
<div id="speakerBioModal" class="fixed inset-0 z-50 hidden opacity-0 transition-opacity duration-300" role="dialog" aria-modal="true" aria-labelledby="speakerModalName" aria-label="<?php echo esc_attr__( 'Speaker bio', 'piedmontglobal' ); ?>">
    <!-- Backdrop -->
    <div class="absolute inset-0 z-0 bg-zinc-950/70 backdrop-blur-[2px]" onclick="closeSpeakerModal()" aria-hidden="true"></div>

    <!-- Modal Content -->
    <div class="pointer-events-none relative z-10 flex min-h-screen items-center justify-center p-4 sm:p-6 md:p-10 lg:p-12">
        <div id="speakerBioModalContent" class="pointer-events-auto relative w-full max-h-[min(88vh,900px)] max-w-5xl overflow-hidden rounded-2xl border border-white/[.09] bg-[#0F1E1E] shadow-[0_25px_80px_-12px_rgba(0,0,0,.65)] transform scale-95 transition-transform duration-300 ease-out">
            <!-- Close Button -->
            <button
                type="button"
                id="speakerModalClose"
                onclick="closeSpeakerModal()"
                class="absolute right-4 top-4 z-20 flex h-10 w-10 items-center justify-center rounded-full border border-white/[.10] bg-white/[.07] text-[#F2EFE9]/60 shadow-sm transition-all duration-200 hover:bg-white/[.12] hover:text-[#F2EFE9] focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#98C441]"
            ...
            <div class="flex h-full max-h-[min(88vh,900px)] flex-col md:flex-row">
                <!-- Left: Photo -->
                <div class="relative md:w-[42%] bg-[#0C1C1C] md:border-r md:border-white/[.07]">
                ...
                <!-- Right: Content -->
                <div class="flex max-h-[min(88vh,900px)] flex-1 flex-col overflow-y-auto overscroll-contain p-6 sm:p-8 md:w-[58%] md:p-10 bg-[#0F1E1E]">
                    <div class="mb-8">
                        ...
                        <h3 id="speakerModalName" class="text-2xl font-semibold tracking-tight text-[#F2EFE9] sm:text-3xl md:text-[2rem] md:leading-tight mb-2"></h3>
                        <p id="speakerModalTitle" class="text-[15px] font-medium leading-snug text-[#F2EFE9]/55 md:text-base"></p>
                    </div>

                    <div class="mb-8 pr-0.5">
                        <div id="speakerModalBio" class="prose prose-invert prose-lg max-w-none text-[15px] leading-relaxed text-[#F2EFE9]/65 symposium-speaker-modal-bio md:text-base"></div>
                    </div>

                    <div id="speakerModalLinkedInWrapper" class="mt-auto hidden border-t border-white/[.07] pt-6">
                        <a
                            id="speakerModalLinkedIn"
                            href=""
                            target="_blank"
                            rel="noopener noreferrer"
                            class="inline-flex items-center gap-2.5 rounded-lg bg-[#1F3131] px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition-all duration-200 hover:bg-[#98C441] hover:text-[#080F0F] focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#98C441]"
                        >
...
?>
<section class="relative overflow-hidden bg-[#060E0E] py-20 md:py-28">
    <div class="symp-atmo symp-atmo--section" aria-hidden="true"></div>
    ...
    <div class="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div class="mb-12 text-center md:mb-16">
            ...
            <h2 class="mb-4 text-[clamp(2rem,4vw,3.4rem)] font-extrabold leading-[1.08] tracking-[-0.042em] text-[#F2EFE9]"><?php echo esc_html($parking_section_title); ?></h2>
            <?php endif; ?>
            <?php if ($parking_section_description): ?>
            <p class="mx-auto max-w-2xl text-base leading-relaxed text-[#F2EFE9]/55 md:text-lg"><?php echo esc_html($parking_section_description); ?></p>
            <?php endif; ?>
        </div>
        <?php endif; ?>
...
<?php endif; ?>
        ...
        <div class="grid grid-cols-1 items-stretch gap-8 lg:grid-cols-2 lg:gap-10 xl:gap-12">
            ...
            <div>
                <div class="flex h-full flex-col overflow-hidden rounded-2xl border border-white/[.10] bg-[#1F3131] shadow-[0_20px_50px_-12px_rgba(15,23,42,0.35)] ring-1 ring-black/20">
                    ...
                    <div class="border-b border-white/[0.08] bg-gradient-to-r from-white/[0.04] to-transparent px-6 py-6 md:px-8 md:py-7">
                        <div class="flex items-start gap-4">
                            <div class="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-xl bg-[#98C441] shadow-[0_4px_14px_rgba(152,196,65,0.35)]">
                    ...
                    <div class="flex flex-1 flex-col p-6 md:p-8">
                        ...
                        <div class="mt-auto flex items-start gap-3 rounded-xl border border-[#98C441]/25 bg-[#98C441]/[0.12] p-4">
            ...
            ?>
            <div id="register">
                <div class="flex h-full flex-col overflow-hidden rounded-2xl bg-white shadow-[0_40px_100px_rgba(0,0,0,.5)] ring-1 ring-white/[.06]">
                    <!-- Top green accent -->
                    <div class="h-[3px] bg-[#98C441] w-full" aria-hidden="true"></div>
                    <!-- Card Content -->
