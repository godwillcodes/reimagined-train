<?php
/**
 * Template Name: Education Campain
 * Description: 
 */
get_header();
?>
...
<main id="maincontent">
    <header class="relative w-full text-white overflow-hidden"
        ...
        <div class="w-full pt-[30%] lg:pt-[12%] px-6 lg:px-0 relative z-20 pb-10 lg:pb-40">
            <div class="text-start gap-y-8 max-w-7xl mx-auto">
                ...
                <a href="https://piedmontglobal.com/webinar/supporting-multilingual-learners-in-special-education/" class="group inline-flex items-center gap-2 mt-8 bg-[#98C441] text-[#1F3131] px-6 py-3 
                    ...
                    <span>View recorded webinar</span>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center">
                ...
                <div class="relative" data-aos="fade-up" data-aos-duration="300" data-aos-delay="100">
                    ...
                    ?>
                        ...
                        <?php endwhile; ?>
                        <?php endif; ?>
					                <a target="_blank" href="https://piedmontglobal.com/webinar/supporting-multilingual-learners-in-special-education/"
   ...
   aria-label=" View recorded webinar"
   data-aos="fade-up"
   data-aos-duration="400"
   data-aos-easing="ease-out"
   data-aos-delay="100">
   View recorded webinar
   <span class="ml-1 text-lg transform transition-transform duration-300 group-hover:translate-x-1">→</span>
</a>
                ...
                <div class="relative" data-aos="fade-up" data-aos-duration="300" data-aos-delay="100">
                    <div class="sticky top-24">
                        ...
                        <div class="flex flex-col gap-y-6 mt-10">
                            <a href="/podcast/the-language-access-lectern/"
                                ...
                                data-aos-delay="100">
                                Language Access Lectern Podcast
                                <span
                            ...
                            <a href="/industry/education/"
                                ...
                                data-aos="fade-up" data-aos-duration="400" data-aos-easing="ease-out"
                                data-aos-delay="100">
                                Strategic Globalization for education
                                <span
                                    class="ml-1 text-lg transform transition-transform duration-300 group-hover:translate-x-1">→</span>
                            </a>
                        </div>
    ...
    <section class="py-20 px-6 md:px-20">
        ...
        ?>
            ...
            <div class="md:col-span-2 bg-[#DFDAD433] rounded border border-[#DFDAD4] p-8 shadow-sm flex flex-col"
                data-aos="fade-up" data-aos-duration="300" data-aos-delay="<?php echo $testimonial_index * 200; ?>">
                <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/icons/quote.svg'); ?>"
                    alt="Quote Icon" class="h-10 w-10 mb-4">
                <div class="h-24"></div>
                <?php if ($title): ?>
            ...
            <!-- 1/3 Column -->
            <div class="bg-[#006155] rounded border border-[#DFDAD4] overflow-hidden shadow-sm" data-aos="fade-up"
                data-aos-duration="300" data-aos-delay="<?php echo ($testimonial_index * 200) + 100; ?>">
    ...
    <section class="bg-[#1F3131] py-28 text-center" aria-labelledby="industry-cta-title">
        <div class="max-w-2xl mx-auto px-4">
            ...
            <p class="mt-6 text-base lg:text-lg text-[#F9F8F6] leading-relaxed" data-aos="fade-up"
                data-aos-duration="300" data-aos-delay="200">
                Together, let’s build a future where every family has a voice – and every student has the opportunity to
                thrive.
            </p>
            ...
            <div class="mt-10 flex flex-col sm:flex-row items-center justify-center gap-6" data-aos="fade-up"
                ...
                <a href="https://piedmontglobal.com/webinar/supporting-multilingual-learners-in-special-education/"
                ...
                <a href="/podcast/the-language-access-lectern/" class="group flex items-center text-[#F9F8F6] font-medium text-base lg:text-lg
