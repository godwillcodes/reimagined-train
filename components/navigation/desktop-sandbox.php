                            ...
                            <ul class="space-y-2">
                                ...
                                <li>
                                    <a href="<?php echo esc_url(get_permalink($post->ID)); ?>"
                                        ...
                                        <span
                                            class="absolute left-0 top-0 h-full w-1 bg-[#98C441] scale-y-0 
                                                 group-hover:scale-y-100 transition-transform duration-300 origin-top"></span>
                                        <span
                                            class="relative z-10 text-sm"><?php echo esc_html(get_the_title($post->ID)); ?></span>
                                    </a>
                                </li>
                                <?php endforeach; ?>
                            </ul>
...
<?php endif; ?>
                    ...
                    <div
                        ...
                        hbspt.forms.create({
                            portalId: "22423917",
                            formId: "be7aa274-4ded-4b22-8cbc-fb5a06e16c0f",
                            region: "na1"
                        });
                        </script> -->
