    ...
    <div class="h-[500px] md:h-[400px] lg:h-[554px] bg-cover bg-top relative"
        ...
        <div class="absolute inset-0 flex items-end">
            <div class="max-w-7xl mx-auto w-full px-10 lg:px-0 pb-4 md:pb-12 lg:pb-12 text-white">
                <h1 class="text-2xl md:text-4xl lg:text-5xl font-bold" data-aos="fade-up" data-aos-duration="300" data-aos-delay="50">
                    Language Operations (LangOps)
                </h1>
                <p class="text-base lg:text-lg my-4 max-w-4xl" data-aos="fade-up" data-aos-duration="300" data-aos-delay="100">
